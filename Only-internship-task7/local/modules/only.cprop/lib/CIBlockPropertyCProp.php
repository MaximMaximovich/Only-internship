...
class CIBlockPropertyCProp
{
                        ...
                        <td>
                            <table class="mf-img-table">
                                <tr>
                                    <td>' . $content . '<br>
                                        <div>
                                            <label><input name="' . $strHTMLControlName['VALUE'] . '[' . $code . '][DEL]" value="Y" type="checkbox"> ' . Loc::getMessage("ONLY_CPROP_FILE_DELETE") . '</label>
    ...
    public static function showTextarea($code, $title, $arValue, $strHTMLControlName)
    {
        ...
        $v = !empty($arValue['VALUE'][$code]) ? htmlspecialcharsEx($arValue['VALUE'][$code]) : '';
        $result .= '<tr>
                    <td align="right" valign="top">' . $title . ': </td>
    ...
    public static function showHtmlEditor($code, $title, $arValue, $strHTMLControlName)
    {
        ...
        $valueName = $strHTMLControlName["VALUE"] . '[' . $code . ']';
        ...
        if ($strHTMLControlName["MODE"] == "FORM_FILL"
          ...
          && Loader::includeModule("fileman")) {
            ...
            ob_start();
            $text_name = preg_replace("/([^a-z0-9])/is", "_", $strHTMLControlName["VALUE"] . "[". $code ."]");
